...
CELERY_BEAT_SCHEDULE = {
    ...
    "reset-order-number": {
        "task": "saleor.order.tasks.reset_order_number_task",
...
BUILTIN_PLUGINS = [
    ...
    "saleor.payment.gateways.balance.plugin.BalanceGatewayPlugin",
...
CONTINUOUS_BALANCE_ADD = [0.5, 1.0, 2.0]
PLUGIN_SETTINGS = {
...
JWT_EXPIRE = True
JWT_TTL_ACCESS = timedelta(seconds=parse(os.environ.get("JWT_TTL_ACCESS", "30 minutes")))
